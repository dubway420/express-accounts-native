    ...
    <View style={logoStyles.container}>
      <ImageBackground source={require('./assets/images/office_space.png')} style={logoStyles.backgroundImage} blurRadius={5}>
        ...
        <View style={boxStyle.boxBottom}>
          ...
          <TouchableOpacity style={boxStyle.appleButton}>

            <Image source={require('./assets/images/apple.png')} style={boxStyle.iconFederated} />
            <Text style={boxStyle.federatedText}>Apple</Text>
